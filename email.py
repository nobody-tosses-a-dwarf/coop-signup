...
async def send_admin_welcome_email(email: str, coop_name: str, temp_password: str):
    ...
    subject = f"Welcome to {coop_name} - Co-op Signup System"
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
        ...
        <p>
            <strong>Login URL:</strong> <a href="https://{BASE_DOMAIN}/login">https://{BASE_DOMAIN}/login</a><br>
...
async def send_member_confirmation_email(email: str, coop_name: str, member_number: int, 
    ...
    subject = f"Welcome to {coop_name}!"
    
    payment_info = {
        'full': f'<strong>Payment:</strong> ${total_amount:.2f} (Paid in Full)',
        'installments': f'<strong>Payment:</strong> ${total_amount:.2f} (Quarterly Installments)',
        'later': f'<strong>Payment:</strong> ${total_amount:.2f} (Pay Later)'
    }.get(payment_plan, '')
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
        ...
        <p style="margin-top: 30px;">
            <strong>The {coop_name} Team</strong>
        </p>
